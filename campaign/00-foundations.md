...
slicing. `01-audience-targeting.md` is written around this constraint —
don't build a Facebook ad set that tries to exclude by age or gender, it
...
**Divorce** and **Inheritance**, which have no professional-graph proxy —
those two lean more heavily on Meta.
