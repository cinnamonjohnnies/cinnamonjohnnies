...
This guide is designed to support you as you consider or move into early retirement. It is a companion to The Checkpoint Strategy™ and offers a simple way to organize your thinking before you make decisions that are difficult to undo.

**What this guide is:**
- A tool to help you gain clarity on the decisions that are unique to retiring early
- A place to capture questions before a conversation with a planner
- A simple structure for the next 90 days

**What this guide is not:**
- A full financial plan
- Tax or legal advice
- A replacement for a Social Security timing analysis or pension election review specific to your situation
...
- What I most want to protect as I make this decision:

There is no need to have this fully resolved today. Naming it is the first step.
...
*Question to answer: Do I understand the tradeoffs of every election option available to me, and has anyone modeled them side by side?*

**4. Portfolio Longevity**
An early retirement means your savings need to last longer than a standard 30-year retirement horizon. A withdrawal rate that works for someone retiring at 65 may not work for someone retiring at 55.
...
List every income source that may apply once you retire.

| Income Source | Current Monthly | Projected Monthly (Post-Retirement) |
|---|---|---|
| Pension | | |
| Social Security (if claiming) | | |
...
Not every decision needs to happen before you retire. Write down what can wait, and when you'll revisit it.
...
- Questions about pension elections:
- Questions about portfolio withdrawal strategy:
